    ...
    data(){
      return {
        ...
        columns:[
          ...
          { title:'创建时间',key:'createTime',align:'center',width:150,render:(h,params)=>{
          ...
          { title:'操作',key:'uid',align:'center',width:220,render:(h,params)=>{
            return h('div',[
               h(permissionButton,{
                props:{type:'primary',size:'small',perStr:'admin:userrole:view',text:'角色'},
              ...
              h(permissionButton,{
                props:{type:'primary',size:'small',perStr:'admin:userperm:view',text:'权限'},
                style:{marginRight:'5px'},
                on:{increment:()=>{
                  this.currentUid = params.row.uid;
              ...
              h(permissionButton,{
                props:{type:'primary',size:'small',perStr:'admin:user:update',text:'修改'},
                style:{marginRight:'5px'},
                on:{increment:()=>{
